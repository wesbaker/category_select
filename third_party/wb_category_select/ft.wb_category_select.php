...
class Wb_category_select_ft extends EE_Fieldtype {
    ...
    {
        return form_radio('wb_category_select[show_parents_only]', 'y', ($data['show_parents_only'] == 'y'), 'id="wb_category_select_show_parents_only_y"') . NL
        . lang('yes', 'wb_category_select_show_parents_only_y') . NBS.NBS.NBS.NBS.NBS . NL
        . form_radio('wb_category_select[show_parents_only]', 'n', ($data['show_parents_only'] == 'n'), 'id="wb_category_select_show_parents_only_n"') . NL
        . lang('no', 'wb_category_select_show_parents_only_n');
    }
